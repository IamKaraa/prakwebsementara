...
<section id="home" class="relative">
  ...
  <div class="absolute top-32 left-8 text-white max-w-md" data-aos="fade-right">
    ...
    <a href="tamu/form_input.php" class="inline-block mt-6 px-6 py-3 bg-green-400 hover:bg-green-500 text-white font-bold rounded-full transition">Get Started</a>
  </div>
</section>

<!-- About -->
<section id="about" class="flex flex-col md:flex-row items-center justify-center gap-8 px-8 py-16 bg-gray-100" data-aos="fade-up">
  <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" alt="Building Icon" class="w-40 h-40" />
  <div class="max-w-lg">
    <h2 class="text-2xl font-bold text-blue-700 mb-2">About the company</h2>
...
<section class="px-8 py-16 bg-white text-center" data-aos="zoom-in-up">
  <h2 class="text-2xl font-bold text-blue-700 mb-10">Statistik Kunjungan Tamu Kantor</h2>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
    <div class="bg-blue-100 rounded-lg p-6 shadow-lg" data-aos="flip-left">
      <div class="text-4xl">👥</div>
      <p class="text-2xl font-bold mt-2">20</p>
      <p>Total Tamu</p>
    </div>
    <div class="bg-blue-100 rounded-lg p-6 shadow-lg" data-aos="flip-left" data-aos-delay="100">
      <div class="text-4xl">📅</div>
      <p class="text-2xl font-bold mt-2">20</p>
      <p>Rata-Rata Tamu Perbulan</p>
    </div>
    <div class="bg-blue-100 rounded-lg p-6 shadow-lg" data-aos="flip-left" data-aos-delay="200">
...
<!-- Contact -->
<section id="contact" class="px-8 py-16 bg-gray-100 flex flex-col md:flex-row justify-between items-start gap-8" data-aos="fade-up">
  <div>
